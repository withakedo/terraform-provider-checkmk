...
import (
	...
	"github.com/withakedo/terraform-provider-checkmk/internal/configuration"
	"github.com/withakedo/terraform-provider-checkmk/internal/groups"
	"github.com/withakedo/terraform-provider-checkmk/internal/hosts"
	"github.com/withakedo/terraform-provider-checkmk/internal/labels"
	"github.com/withakedo/terraform-provider-checkmk/internal/rules"
	"github.com/withakedo/terraform-provider-checkmk/internal/rules/wrappers"
	"github.com/withakedo/terraform-provider-checkmk/internal/users"
)
